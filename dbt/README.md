...
The `terraform-kots-eks` project was originally born in the github.com/dbt-labs org.
...
This folder exists as part of an effort to ensure that the generic module can still be used with DBT-specific logic to provision DBT on top of KOTS + EKS.

### Status

This module and the examples inside it are a work in progress and are not expected to work (yet).
